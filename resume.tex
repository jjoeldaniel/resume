...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Collaborated with peers including stand-ups and daily one-on-one meetings }
            \resumeItem{Mentored by Meta production engineers on topics such as continuous integration and delivery, containerization, and networking}
          \resumeItemListEnd
    \resumeProjectHeading
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Co-developed data science project involving visualizing COVID-19 statistics in accessible format}
            \resumeItem{Literally cured cancer}
          \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
              {\textbf{Trends Analysis} $|$ \emph{Python, Rust}}{Jan. 2022 -- Present}
              \resumeItemListStart
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, Rust, C++, Java, JavaScript, TypeScript, SQL (Postgres, SQLite), HTML, CSS } \\
